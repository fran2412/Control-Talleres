...
namespace ControlTalleresMVP.Migrations
{
    ...
    [Migration("20260228202923_EliminarRelacionConfiguracionSede")]
    partial class EliminarRelacionConfiguracionSede
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControlTalleresMVP.Persistence.Models.Clase", b =>
                {
                    b.Property<int>("ClaseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("ControlTalleresMVP.Persistence.Models.ConfiguracionSede", b =>
                {
                    b.Property<int>("ConfiguracionSedeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasColumnName("id_configuracion_sede");
                    ...
                    b.HasKey("ConfiguracionSedeId");

                    b.HasIndex("SedeId", "Clave")
                        .IsUnique();

                    b.ToTable("configuraciones_sede", (string)null);
                });
            ...
            modelBuilder.Entity("ControlTalleresMVP.Persistence.Models.Cargo", b =>
                {
                    ...
                    b.HasOne("ControlTalleresMVP.Persistence.Models.Clase", "Clase")
                        .WithMany()
            ...
            modelBuilder.Entity("ControlTalleresMVP.Persistence.Models.Sede", b =>
                {
                    ...
                    b.Navigation("ConfiguracionesSede");
